...
# SETUPX CLI - Modular Windows Development Environment Setup
# Version: 2.0
# Author: SetupX Team
...
function Show-Banner {
    ...
    Write-SetupxOutput "║                    SETUPX CLI v2.0                          ║" $Global:SetupxColors.Primary
...
function Show-Help {
    ...
    Write-SetupxOutput "  .\setupx-cli.ps1 [command] [options]" $Global:SetupxColors.Info
    Write-SetupxOutput ""
    ...
    Write-SetupxOutput "  update <module>          Update module components" $Global:SetupxColors.Info
    Write-SetupxOutput "  components <module>      List module components" $Global:SetupxColors.Info
    Write-SetupxOutput "  menu                    Show interactive menu (default)" $Global:SetupxColors.Info
    Write-SetupxOutput ""
    Write-SetupxOutput "OPTIONS:" $Global:SetupxColors.Secondary
    Write-SetupxOutput "  -Module <name>           Specify module name" $Global:SetupxColors.Info
    Write-SetupxOutput "  -Component <name>        Specify component name" $Global:SetupxColors.Info
    Write-SetupxOutput "  -Verbose                 Enable verbose logging" $Global:SetupxColors.Info
    Write-SetupxOutput "  -Help                    Show this help" $Global:SetupxColors.Info
    Write-SetupxOutput ""
    Write-SetupxOutput "EXAMPLES:" $Global:SetupxColors.Secondary
    Write-SetupxOutput "  .\setupx-cli.ps1 list" $Global:SetupxColors.Info
    Write-SetupxOutput "  .\setupx-cli.ps1 install -Module web-development" $Global:SetupxColors.Info
    Write-SetupxOutput "  .\setupx-cli.ps1 test -Module common-development" $Global:SetupxColors.Info
    Write-SetupxOutput "  .\setupx-cli.ps1 components -Module package-managers" $Global:SetupxColors.Info
}
...
function Show-ModuleComponents {
    ...
    if (!$ModuleName) {
        Write-SetupxOutput "❌ Module name required. Use: .\setupx-cli.ps1 components -Module <name>" $Global:SetupxColors.Error
        return
    }
...
function Test-ModuleComponents {
    ...
    if (!$ModuleName) {
        Write-SetupxOutput "❌ Module name required. Use: .\setupx-cli.ps1 test -Module <name>" $Global:SetupxColors.Error
        return
    }
...
function Install-Module {
    ...
    if (!$ModuleName) {
        Write-SetupxOutput "❌ Module name required. Use: .\setupx-cli.ps1 install -Module <name>" $Global:SetupxColors.Error
        return
    }
...
switch ($Action.ToLower()) {
    ...
    default {
        ...
        Write-SetupxOutput "Use -Help to see available commands" $Global:SetupxColors.Info
    }
}