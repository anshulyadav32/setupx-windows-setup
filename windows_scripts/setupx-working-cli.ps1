...
function Show-Help {
    ...
    Write-Output "  .\setupx-working-cli.ps1 [command] [options]" $Colors.Info
    Write-Output ""
    ...
    Write-Output "  .\setupx-working-cli.ps1 list" $Colors.Info
    Write-Output "  .\setupx-working-cli.ps1 components -Module web-development" $Colors.Info
    Write-Output "  .\setupx-working-cli.ps1 test -Module common-development" $Colors.Info
}
