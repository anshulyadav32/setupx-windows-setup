...
function Show-DetailedIndex {
    ...
    foreach ($manager in $componentsByManager.Keys) {
        $count = $componentsByManager[$manager]
        Write-Output "  $manager : $count components" "White"
    }
}
...
Write-Output "  .\index-working.ps1                    # Module index" "White"
Write-Output "  .\index-working.ps1 -Detailed          # Detailed index" "White"
Write-Output "  .\index-working.ps1 -Module web-dev   # Component index" "White"
Write-Output "  .\index-working.ps1 -Json             # JSON output" "White"
