...
function Show-Banner {
    Write-Output ""
    Write-Output "╔══════════════════════════════════════════════════════════════╗" "Cyan"
    Write-Output "║                SETUPX MODULE & COMPONENT INDEX              ║" "Cyan"
...
function Show-DetailedIndex {
    Show-Banner
    Write-Output "📋 DETAILED MODULE & COMPONENT INDEX" "Magenta"
    Write-Output ""
    ...
    foreach ($module in $modules) {
        ...
        if ($module.Components) {
            Write-Output "   🔧 COMPONENTS ($($module.Components.Count) total):" "Yellow"
            foreach ($component in $module.Components) {
                Write-Output "     • $($component.name)" "White"
                Write-Output "       Description: $($component.description)" "Gray"
                Write-Output "       Package: $($component.package)" "Gray"
            ...
            Write-Output "   ⚠️ No components configured" "Yellow"
        }
